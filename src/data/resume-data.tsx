...
export const RESUME_DATA = {
  ...
  quote: "Cody has demonstrated his dedication to the teaching profession on a weekly basis, and wants all akonga to experience success in his lessons. You have demonstrated your commitment to teaching where you can share your own learning.", 
  summary:
