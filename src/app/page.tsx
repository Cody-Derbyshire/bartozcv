...
export default function Page() {
  return (
    <main className="blue-bg container relative mx-auto scroll-my-12 overflow-auto p-4 text-white print:bg-zinc-100 print:p-0 md:p-16">
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-transparent text-white print:space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex-1 space-y-1.5">
            <h1 className="text-5xl font-black print:text-2xl print:text-neutral-600">
              {RESUME_DATA.name}
            </h1>
        ...
        <Section>
          <h2 className="text-xl font-black print:text-neutral-600">Skills</h2>
